# Contributing to OptoLlama

Welcome to ``OptoLlama`` :sunglasses:! We're thrilled that you're interested in contributing to our open-source project.
...
5. **Make Changes**: Make your desired changes to the codebase. Please stick to the following guidelines:
   * `OptoLlama` uses [*Black*](https://black.readthedocs.io/en/stable/the_black_code_style/current_style.html) code style and so should you if you would like to contribute.
   * Please use type hints in all function definitions.
   * Please use American English for all comments and docstrings in the code.
   * `OptoLlama` uses Sphinx autoapi to automatically create API reference documentation from docstrings in the code.
...
9. **Open a Pull Request**: Go to the [original repository](https://github.com/jnitzz/OptoLlama) and click the "New Pull Request" button. Follow the guidelines in the template to submit your pull request.
...
If you have questions or encounter any issues, please create an issue in the [Issues](https://github.com/jnitzz/OptoLlama/issues) section of this repository.
