...
import json
from bragg_stack_finder import parse_tokens, detect_Bragg, detect_Bragg_continued, detect_Bragg_only_length_3
...
if __name__ == "__main__":
    ...
    for option in ["continued"]: #["regular", "continued", "just_len_3"]
